...
import resend  # Simplified import
...
def main():
    ...
    try:
        resend_client = resend.Client(api_key)  # Updated client initialization
    ...
    try:
        ...
        response = resend_client.emails.send({  # Using resend_client
            "from": email_from,
            "to": email_to,
